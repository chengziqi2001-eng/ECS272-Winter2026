...
export default function App() {
  ...
  <div className="panel">
    ...
    <CountryBarChart data={rows} topN={15} width={380} height={280} />

  </div>

  <div className="panel" style={{ gridRow: "1 / span 2", gridColumn: "2" }}>
    <h3>View 3 (Advanced): Sankey Flow</h3>
    <CountryDisciplineGenderSankey data={rows} width={900} height={640} />
  </div>

  <div className="panel">
    <h3>View 2 (Focus): Height vs Weight</h3>
    <HeightWeightScatter data={rows} width={380} height={280} />
